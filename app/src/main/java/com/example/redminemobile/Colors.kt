...
class ThemeColors(context: Context) {
    ...
    companion object {
        ...
        fun setNewThemeColor(activity: Activity, red: Int, green: Int, blue: Int) {
            ...
            val editor: SharedPreferences.Editor = activity.getSharedPreferences(NAME, Context.MODE_PRIVATE).edit()
    ...
    init {
        ...
        if (isLightActionBar) context.setTheme(R.style.Theme_RedmineMobile)
